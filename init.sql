...
create table temperature1(v decimal(5,3),ts datetime primary key, IsNormal boolean,IsChecked boolean);
create table humidity(v decimal(5,3),ts datetime primary key,IsNormal boolean,IsChecked boolean);
create table locationx(v decimal(5,3),ts datetime primary key, IsNormal boolean,IsChecked boolean);
create table locationy(v decimal(5,3),ts datetime primary key, IsNormal boolean,IsChecked boolean);
create table vibration(v decimal(5,3),ts datetime primary key, IsNormal boolean,IsChecked boolean);
create table i(v decimal(5,3),ts datetime primary key, IsNormal boolean,IsChecked boolean);
create table u(v decimal(7,3),ts datetime primary key, IsNormal boolean,IsChecked boolean);
create table voice(v decimal(5,3),ts datetime primary key, IsNormal boolean,IsChecked boolean);
